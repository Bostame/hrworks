"""
Django settings for hrworks project.
...
SECRET_KEY = 'django-insecure-0p0^7^4rhx$2rdb+(g0$o+%#&1cdzf3y(x)*)!kqu2z_e5cr+y'
...
WSGI_APPLICATION = 'hrworks.wsgi.application'
